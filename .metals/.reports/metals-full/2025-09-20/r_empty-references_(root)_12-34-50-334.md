error id: <WORKSPACE>/src/main/scala/gibbon/handling/monitoring/EventContext.scala:SymbolOccurrence(Some(Range(7,4,7,10)),gibbon/handling/monitoring/EventContext#offset.,DEFINITION)
...
Could not find any locations for Some(SymbolOccurrence(Some(Range(7,4,7,10)),gibbon/handling/monitoring/EventContext#offset.,DEFINITION)), printing index state