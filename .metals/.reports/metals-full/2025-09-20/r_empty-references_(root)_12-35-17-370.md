error id: <WORKSPACE>/src/main/scala/gibbon/core/Event.scala:SymbolOccurrence(Some(Range(3,4,3,7)),gibbon/core/Event#key.,DEFINITION)
...
Could not find any locations for Some(SymbolOccurrence(Some(Range(3,4,3,7)),gibbon/core/Event#key.,DEFINITION)), printing index state