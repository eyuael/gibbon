error id: <WORKSPACE>/src/main/scala/gibbon/handling/monitoring/MetricsCollector.scala:SymbolOccurrence(Some(Range(6,4,6,8)),gibbon/handling/monitoring/Metric#name.,DEFINITION)
...
Could not find any locations for Some(SymbolOccurrence(Some(Range(6,4,6,8)),gibbon/handling/monitoring/Metric#name.,DEFINITION)), printing index state