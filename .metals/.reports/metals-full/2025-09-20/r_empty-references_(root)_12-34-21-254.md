error id: <WORKSPACE>/src/main/scala/gibbon/handling/monitoring/MetricsCollector.scala:SymbolOccurrence(Some(Range(8,4,8,13)),gibbon/handling/monitoring/Metric#timestamp.,DEFINITION)
...
Could not find any locations for Some(SymbolOccurrence(Some(Range(8,4,8,13)),gibbon/handling/monitoring/Metric#timestamp.,DEFINITION)), printing index state