error id: <WORKSPACE>/src/main/scala/gibbon/core/Event.scala:SymbolOccurrence(Some(Range(4,4,4,9)),gibbon/core/Event#value.,DEFINITION)
...
Could not find any locations for Some(SymbolOccurrence(Some(Range(4,4,4,9)),gibbon/core/Event#value.,DEFINITION)), printing index state