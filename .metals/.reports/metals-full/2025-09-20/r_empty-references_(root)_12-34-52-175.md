error id: <WORKSPACE>/src/main/scala/gibbon/handling/monitoring/EventContext.scala:SymbolOccurrence(Some(Range(6,4,6,13)),gibbon/handling/monitoring/EventContext#partition.,DEFINITION)
...
Could not find any locations for Some(SymbolOccurrence(Some(Range(6,4,6,13)),gibbon/handling/monitoring/EventContext#partition.,DEFINITION)), printing index state