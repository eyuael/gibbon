...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_checkpoints1)
       tree position: line 438 of file://<WORKSPACE>/src/test/scala/gibbon/integration/CheckpointRecoveryIntegrationSpec.scala
            tree tpe: <error>
...
== Source file context for tree position ==
   ...
   435         assertEquals(finalResults2.head.originalId, 20L)
   436         
   437         // Each pipeline should have separate checkpoint history
   438         assert(_CURSOR_checkpoints1.nonEmpty)
