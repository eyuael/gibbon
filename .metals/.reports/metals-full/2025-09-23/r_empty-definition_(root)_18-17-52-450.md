...
non-local guesses:
	 -org/apache/pekko/actor/Actor.Cancellable.
	 -org/apache/pekko/actor/Actor.Cancellable#
	 -org/apache/pekko/actor/Actor.Cancellable().
	 -pekko/Actor.Cancellable.
	 -pekko/Actor.Cancellable#
	 -pekko/Actor.Cancellable().
	 -scala/Predef.pekko.Actor.Cancellable.
	 -scala/Predef.pekko.Actor.Cancellable#
	 -scala/Predef.pekko.Actor.Cancellable().
offset: 1277
...
class PekkoStreamingRuntime extends StreamingRuntime {
  ...
  def tick[T](initialDelay: FiniteDuration, interval: FiniteDuration, tick: T)(implicit ec: ExecutionContext): Source[T, NotUsed] = 
    PekkoSource.tick(initialDelay, interval, tick).mapMaterializedValue(_ => pekko.Actor.Can@@cellable)
}
```
