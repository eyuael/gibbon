...
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/gibbon/sinks/ConsoleSink.scala,line-1,offset=41
...
text:
```scala
//ConsoleSink for Debugging and developem@@
